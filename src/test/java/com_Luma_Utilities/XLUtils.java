...
public class XLUtils {
	...
	public static int getRowCount(String xlfile,String xlsheet) throws IOException {
		...
		sheet=wb.getSheet(xlsheet); // don't provide the static value provide dynamical value(xlsheet) it will applicable for all testcases
	...
	//return type String-sheet data is in string format 
	public static String getcelldata(String xlfile,String xlsheet,int rownum,int cellnum) throws IOException {
		...
		try {
			...
			DataFormatter formatter=new DataFormatter();// it will convert into good format
    ...
    //What ever data you need get, you need to set in proper format,
	//Bacause selenium some times data not read properly then we need to set the data and read.
